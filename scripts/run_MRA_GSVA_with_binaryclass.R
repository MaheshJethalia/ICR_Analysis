...
gsvaout_icr_related <- gsvaout[,c(high_indices,low_indices)]
...
fit <- lmFit(gsvaout_icr_related, design)
fit <- eBayes(fit)
...
#=================================================================================================
# new_mr_activity_matrix <- as.matrix(gsvaout_icr_related[rownames(DEgeneSets),])

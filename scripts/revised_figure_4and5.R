...
#Figure 5A
#====================================================================================
pdf("../Results/Revised_Figures/Pdfs/Different_TopMRs_Activity_ICR_High_Figure_Revised(v2)_5A.pdf",height = 10, width=12, pointsize = 12)
par(bg="white")
...
#Activity of MRs specific to ICR High in all 12 cancers of interest (Figures 4D, 5B)
#==============================================================================================================================
...
pdf("../Results/Revised_Figures/Pdfs/Different_TopMRs_Activity_ICR_Low_Figure_Revised(v2)_5B.pdf",height = 10, width=12, pointsize = 12)
par(bg="white")
par(fg="black",col.axis="black",col.main="black",col.lab="black", cex.main=1.0)
...
#Make figures for downstream enrichment analysis (Supp 7A, 7B)
##################################################################################################################################
...
ggsave(file="../Results/Revised_Figures/Svgs_Jpgs/Supp_Figure_Revised(v2)_7A.jpg",plot = supp_p7a, device = jpeg(), width = 7, height=6, units = "in", dpi = 300)
dev.off()
...
ggsave(file="../Results/Revised_Figures/Svgs_Jpgs/Supp_Figure_Revised(v2)_7B.jpg",plot = supp_p7b, device = jpeg(), width = 7, height=6, units = "in", dpi = 300)
dev.off()
...
ggsave(filename = "../Results/Revised_Figures/Pdfs/Enriched_Pathways_ICR_Low_Figure_Revised(v2)_6A_2.pdf",plot=p5,device=pdf(), height=12, width=15, units="in", dpi=300)
dev.off()
...
ggsave(filename = "../Results/Revised_Figures/Svgs_Jpgs/Supp_Figure_Revised(v2)_8A.jpg",plot=supp_p8a,device=jpeg(), height=15, width=12, units="in", dpi=300)
dev.off()
...
jpeg("../Results/Revised_Figures/Svgs_Jpgs/Supp_Figure_Revised(v2)_8B.jpg",height = 900, width=1500, units="px",pointsize = 12)
...
#Figure S8C
jpeg("../Results/Revised_Figures/Svgs_Jpgs/Supp_Figure_Revised(v2)_8C.jpg",height = 600, width=900, units="px",pointsize = 15, res = 0.75)
...
widget2png(p, "../Results/Revised_Figures/Svgs_Jpgs/Sankey_Plot_ICR_Low_Figure_Revised(v2)_6A_1.png")
...
g_final <- ggarrange(p1,p2,p3,p4,nrow=2,ncol=2,labels=c("A","B","C","D"),widths=c(2,2))
...
g_final <- ggarrange(p5,p6, nrow=1, ncol=2, labels = c("A","B"), widths = c(2,2))
ggsave(filename = paste0("../Results/Revised_Figures/Figure_Revised(v2)_5.pdf"),device=pdf(), plot = g_final, dpi = 300, width = 8, height = 8, units = "in")
dev.off()
